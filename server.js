...
// 6. Tes Endpoint Sederhana (Root URL)
app.get('/', (req, res) => {
  res.status(200).json({
    status: 'success',
    message: '🚀 API Server Kecamatan Tanete Riaja Berjalan Sempurna!',
...
app.use((err, req, res, next) => {
  ...
  res.status(statusCode).json({
    ...
    // Hanya tampilkan detail stack trace jika masih di environment development
